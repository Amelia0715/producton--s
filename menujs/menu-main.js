 ...
 */
{
    ...
    document.querySelector('.content__title').addEventListener('click', () => {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        // 获取 WORK 菜单项
        const workMenuItem = document.querySelector('.menu__item');
        const contentTitle = document.querySelector('.content__title');
        
        // 预加载 works.html 的内容
        const preloadWorksContent = () => {
        ...
        // 添加点击事件
        workMenuItem.addEventListener('click', (e) => {
            e.preventDefault();
            handleWorkClick();
        });
        ...
        function handleWorkClick() {
            ...
            // 先执行原有的过渡动画
            const revealer = document.querySelector('.content--reveal');
            revealer.classList.add('content--reveal-out');
        ...
        menuItems.forEach(item => {
            ...
            item.addEventListener('mousemove', (e) => {
                ...
                gsap.to(item, {
                    ...
                    rotateY: mouseX * 10,
                    scale: 1.1,
                    textShadow: `${mouseX * 5}px ${mouseY * 5}px 10px rgba(0, 255, 252, 0.3)`,
                    ease: 'power2.out'
                });
            });
